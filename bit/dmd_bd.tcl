...
################################################################
# This is a generated script based on design: dmd
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: dmd_0, and set properties
  set dmd_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:dmd:1.0 dmd_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins dmd_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net dmd_0_clk_n [get_bd_ports clk_n] [get_bd_pins dmd_0/clk_n]
  connect_bd_net -net dmd_0_clk_p [get_bd_ports clk_p] [get_bd_pins dmd_0/clk_p]
  connect_bd_net -net dmd_0_data_n [get_bd_ports data_n] [get_bd_pins dmd_0/data_n]
  connect_bd_net -net dmd_0_data_p [get_bd_ports data_p] [get_bd_pins dmd_0/data_p]
  connect_bd_net -net dmd_0_trig [get_bd_ports trig] [get_bd_pins dmd_0/trig]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins dmd_0/clk] [get_bd_pins dmd_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins dmd_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dmd_0/S00_AXI/S00_AXI_reg] -force
